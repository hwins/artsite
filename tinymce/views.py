...
# correction to make spell_check work - json needs str not bytes
...
def spell_check(request):
    ...
    try:
        ...
        raw = request.body
        # hack from release 2.0.6 to get spell check to work - Python 3 related?
        input = json.loads(raw.decode("utf8"))
        id = input['id']
        method = input['method']
        params = input['params']
        lang = params[0]
